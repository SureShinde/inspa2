...
return [
    'modules' => [
        ...
        'Magento_Indexer' => 1,
        'Devbatch_Custom' => 1,
        'Devbatch_LayeredNavigation' => 1,
        'Devbatch_UpdateQuantity' => 1,
        'Devbatch_Zenoti' => 0,
        'Magento_Variable' => 1,
        'Magento_Cms' => 1,
        'Magento_Catalog' => 1,
        'Esparksinc_Customer' => 1,
        'Magento_Payment' => 1,
        'Magento_Quote' => 1,
        'Magento_Rule' => 1,
        'Lof_All' => 1,
        ...
        'Devbatch_ConfigurableProduct' => 1,
        ...
        'Devbatch_CategoryShortDescription' => 1,
