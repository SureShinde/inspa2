 ...
 */
namespace Lof\SmsNotification\Block\Adminhtml\Blacklist\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('lofsmsnotification_blacklist');

        if ($this->_isAllowedAction('Lof_SmsNotification::blacklist')) {
