 ...
 * Class PageActions
 */
class PhoneActions extends Column
{
    /** Url path */
    const CMS_URL_PATH_DELETE   = 'lofsmsnotification/phone/delete';
    const CMS_URL_PATH_EDIT   = 'lofsmsnotification/phone/edit';
