 ...
 * Class PageActions
 */
class SmslogActions extends Column
{
    /** Url path */
    const CMS_URL_PATH_DELETE   = 'lofsmsnotification/smslog/delete';
    const CMS_URL_PATH_PREVIEW  = 'lofsmsnotification/smslog/preview';
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['smslog_id'])) {
                    ...
                    $item[$name]['delete'] = [
                            ...
                            'label' => __('Delete'),
                            'confirm' => [
                                'title' => __('Delete "${ $.$data.recipient_sms }"'),
                                'message' => __('Are you sure you wan\'t to delete a "${ $.$data.recipient_sms }" record?')
                            ]
                    ];  
                    $item[$name]['preview'] = [
                        'label' => __('Preview'),
                         'confirm' => [
                            'title' => '<div class="lof-preview">'.$item['from'].'</div>',
