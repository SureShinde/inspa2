...
class Edit extends \Lof\SmsNotification\Controller\Adminhtml\Blacklist
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Lof_SmsNotification::blacklist_edit');
    }

    /**
     * Edit SmsNotification Form
     *
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('lofsmsnotification_blacklist', $model);  
