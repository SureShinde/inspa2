...
class MessageLink extends Column
{
    /** Url path */
    const FORM_URL_PATH_EDIT = 'formbuilder/message/edit';
    const FORM_URL_PATH_DELETE = 'formbuilder/message/delete';
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['message_id']) && $item['message_id']) {
                    $item[$name]['edit'] = [
