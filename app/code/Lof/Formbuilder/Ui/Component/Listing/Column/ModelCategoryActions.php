...
class ModelCategoryActions extends Column
{
    /** Url path */
    const FORM_URL_PATH_EDIT = 'formbuilder/modelcategory/edit';
    const FORM_URL_PATH_DELETE = 'formbuilder/modelcategory/delete';
