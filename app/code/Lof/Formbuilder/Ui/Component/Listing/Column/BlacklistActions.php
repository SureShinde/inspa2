...
{
    /** Url path */
    const FORM_URL_PATH_EDIT = 'formbuilder/blacklist/edit';
    const FORM_URL_PATH_DELETE = 'formbuilder/blacklist/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['blacklist_id'])) {
                    $item[$name]['edit'] = [
                    'href' => $this->urlBuilder->getUrl($this->editUrl, ['blacklist_id' => $item['blacklist_id']]),
                    'label' => __('Edit')
                    ];
                }
            }
