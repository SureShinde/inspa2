...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        ->addIndex(
            $installer->getIdxName('lof_formbuilder_form', ['form_id']),
            ['form_id']
        )
        ->addIndex(
                $setup->getIdxName('lof_formbuilder_form', 
                    ['title','identifier','success_message','before_form_content','after_form_content'],  
        ...
        ->addIndex(
            $installer->getIdxName('lof_formbuilder_message', ['form_id','product_id','customer_id']),
            ['form_id','product_id','customer_id']
        )
        ->addIndex(
                $setup->getIdxName('lof_formbuilder_message', 
