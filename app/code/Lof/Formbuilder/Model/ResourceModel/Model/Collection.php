...
namespace Lof\Formbuilder\Model\ResourceModel\Model;
...
class Collection extends \Lof\Formbuilder\Model\ResourceModel\AbstractCollection
{
    ...
    {
        $this->_init('Lof\Formbuilder\Model\Model', 'Lof\Formbuilder\Model\ResourceModel\Model');
    }
    ...
    {
        return $this->_toOptionArray('model_id', 'title');
    }
