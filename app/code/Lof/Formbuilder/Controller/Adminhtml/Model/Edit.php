...
class Edit extends \Lof\Formbuilder\Controller\Adminhtml\Model
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Lof_Formbuilder::model_edit');
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('formbuilder_model', $model);
