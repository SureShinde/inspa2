...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_Formbuilder::blacklist_save')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
        ...
        if ($this->_isAllowedAction('Lof_Formbuilder::blacklist_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('formbuilder_form')->getId()) {
            return __("Edit Blacklist '%1'", $this->escapeHtml($this->_coreRegistry->registry('formbuilder_blacklist')->getTitle()));
        } else {
