...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected $_formatDateFormBuilder;
    ...
    public function __construct(
        ...
        \Lof\Formbuilder\Helper\Data $formatDateFormBuilder,
        array $data = []
    ) {
        ...
        $this->_formatDateFormBuilder = $formatDateFormBuilder;
    ...
    protected function _prepareForm()
    {
        ...
        if ($this->_isAllowedAction('Lof_Formbuilder::blacklist_edit')) {
        ...
        if ($model->getId()) {
            ...
            if ($model->getMessageId()) {
                $message_link = '<a href="'.$this->getUrl('*/message/edit/message_id/'.$model->getMessageId()).'" target="_BLANK">'.__('View message').'</a>';
            }
            if ($model->getFormId()) {
                $form_link = '<a href="'.$this->getUrl('*/form/edit/form_id/'.$model->getFormId()).'" target="_BLANK">'.__('View form profile').'</a>';
            }
        }
        ...
        if ($model->getId()) {
            ...
            $fieldset->addField(
                ...
                [
                    ...
                    'label' => __('Created At'),
                    'title' => __('Created At'),
                    'text' => $this->_formatDateFormBuilder->FormatDateFormBuilder($model->getCreatedTime()),
                ]
            );
        }
        if (!$model->getId()) {
