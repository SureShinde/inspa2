...
class Email extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function toHtml()
    {
        ...
        if ($model->getId()) {
            $html = '<div class="reply-wrapper" style="font-weight: bold;padding: 20px 0;">'.$this->getLayout()->createBlock('Lof\Formbuilder\Block\Adminhtml\Message\Edit\Tab\Detail')->setMessageModel($model)->toHtml().'</div>';
        }
        return $html;
    }
