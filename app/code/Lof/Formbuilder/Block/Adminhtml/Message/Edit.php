...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_Formbuilder::message_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('formbuilder_form')->getId()) {
            return __("Edit Message '%1'", $this->escapeHtml($this->_coreRegistry->registry('formbuilder_message')->getTitle()));
        } else {
