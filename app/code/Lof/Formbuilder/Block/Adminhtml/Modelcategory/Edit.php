...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_Formbuilder::category_save')) {
        ...
        if ($this->_isAllowedAction('Lof_Formbuilder::category_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('formbuilder_modelcategory')->getId()) {
            return __("Edit Category '%1'", $this->escapeHtml($this->_coreRegistry->registry('formbuilder_modelcategory')->getTitle()));
        } else {
