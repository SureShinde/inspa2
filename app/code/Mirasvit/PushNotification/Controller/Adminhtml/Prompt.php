...
abstract class Prompt extends Action
{
    /**
    ...
    public function initModel()
    {
        ...
        if ($this->getRequest()->getParam(PromptInterface::ID)) {
            $model = $this->promptRepository->get($this->getRequest()->getParam(PromptInterface::ID));
        }
    ...
    {
        return $this->context->getAuthorization()->isAllowed('Mirasvit_PushNotification::push_notification_prompt');
    }
}
