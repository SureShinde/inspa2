 ...
 */
namespace Magebest\Brand\Model\ResourceModel\Brand;
...
class Collection extends AbstractCollection
{
	...
	{
		$this->_init('Magebest\Brand\Model\Brand', 'Magebest\Brand\Model\ResourceModel\Brand');
    ...
    {
        $this->performAfterLoad('magebest_brand_store', 'brand_id');
    ...
    {
        $this->joinStoreRelationTable('magebest_brand_store', 'brand_id');
    }
    /**
