...
{	
     ...
     * @param \Magebest\Brand\Model\ResourceModel\Group|null                      $resource                 
     * @param \Magebest\Brand\Model\ResourceModel\Group\Collection|null           $resourceCollection       
    ...
    public function __construct(
        ...
        \Magebest\Brand\Model\ResourceModel\Group $resource = null,
        \Magebest\Brand\Model\ResourceModel\Group\Collection $resourceCollection = null,
    ...
    {
        $this->_init('Magebest\Brand\Model\ResourceModel\Group');
    }
    ...
    public function getUrl()
    {
        ...
        $route = $this->_scopeConfig->getValue(
            'magebestbrand/general_settings/route',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store);
        $url_prefix = $this->_scopeConfig->getValue(
            'magebestbrand/general_settings/url_prefix',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store);
        $url_suffix = $this->_scopeConfig->getValue(
            'magebestbrand/general_settings/url_suffix',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store);
        $urlPrefix = '';
        if($url_prefix){
