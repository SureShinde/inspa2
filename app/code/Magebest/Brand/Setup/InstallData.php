...
use Magebest\Brand\Model\Brand;
use Magebest\Brand\Model\BrandFactory;
use Magebest\Brand\Model\Group;
use Magebest\Brand\Model\GroupFactory;
	...
	public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
	{
		$eavSetup = $this->eavSetupFactory->create(['setup' => $setup]);
 		$data = array(
 			...
 			'frontend' => '',
 			'source' => 'Magebest\Brand\Model\Brandlist',
 			'visible' => 1,
 			'required' => 1,
 			'user_defined' => 1,
