 ...
 * @copyright  Copyright (c) 2017 Magebest (https://www.magebest.com/)
 * @license    https://www.magebest.com/LICENSE.txt
 */
namespace Magebest\Brand\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        if($this->_isAllowedAction('Magebest_Brand::import')){
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Magebest Brand Import')]);
