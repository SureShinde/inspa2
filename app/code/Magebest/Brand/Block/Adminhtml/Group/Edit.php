 ...
 */
namespace Magebest\Brand\Block\Adminhtml\Group;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Magebest_Brand::group_save')){
    	...
    	if ($this->_isAllowedAction('Magebest_Brand::grou_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('magebest_brand')->getId()) {
            return __("Edit Group '%1'", $this->escapeHtml($this->_coreRegistry->registry('magebest_brand')->getName()));
        } else {
            return __('New Group');
        }
    }
