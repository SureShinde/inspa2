 ...
 */
namespace Magebest\Brand\Block\Adminhtml\Brand\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @param \Magebest\Brand\Helper\Data                  $viewHelper    
     * @param array                                   $data          
     */
    public function __construct(
        ...
        \Magebest\Brand\Helper\Data $viewHelper,
        array $data = []
    ) {
    ...
    protected function _prepareForm() {
    	/** @var $model \Magebest\Brand\Model\Brand */
    	$model = $this->_coreRegistry->registry('magebest_brand');
        
        $wysiwygConfig = $this->_wysiwygConfig->getConfig(['tab_id' => $this->getTabId()]);
    	/**
    	 * Checking if user have permission to save information
    	 */
    	if($this->_isAllowedAction('Magebest_Brand::brand_edit')){
