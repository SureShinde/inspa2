 ...
 */
namespace Magebest\Brand\Block\Adminhtml\Brand;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	$this->_blockGroup = 'Magebest_Brand';
    	$this->_controller = 'adminhtml_brand';

    	parent::_construct();

    	if($this->_isAllowedAction('Magebest_Brand::brand_save')){
    	...
    	if ($this->_isAllowedAction('Magebest_Brand::brand_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('magebest_brand')->getId()) {
            return __("Edit Brand '%1'", $this->escapeHtml($this->_coreRegistry->registry('magebest_brand')->getName()));
        } else {
            return __('New Brand');
        }
    }
