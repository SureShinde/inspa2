 ...
 */
namespace Magebest\Brand\Block\Search;
...
class Result extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Magebest\Brand\Model\Brand
     */
    ...
    protected function _prepareLayout()
    {
        ...
        $this->pageConfig->addBodyClass('magebest-brandlist');
        if($page_title){
    ...
    {
        $block = $this->getLayout()->getBlock('magebestbrand_toolbar');
        if ($block) {
