...
define([
    ...
    'Magebest_Brand/js/magebestbrowser'
], function(jQuery, _, tinyMCE) {

    magebestTinyMceWysiwygSetup = Class.create();

    magebestTinyMceWysiwygSetup.prototype = {
        ...
        // retrieve directimagebest URL with substituted directive value
        makeDirectiveUrl: function(directive) {
            return this.config.directimagebest_url.replace('directive', 'directive/___directive/' + directive);
        },

        encodeDirectimagebest: function(content) {
            // collect all HTML tags with attributes that contain directimagebest
        ...
        decodeDirectimagebest: function(content) {
            // escape special chars in directimagebest url to use it in regular expression
        ...
        beforeSetContent: function(o){
            if (this.config.add_widgets) {
                ...
                o.content = this.encodeDirectimagebest(o.content);
            } else if (this.config.add_directimagebest) {
                o.content = this.encodeDirectimagebest(o.content);
            }
        },
        ...
        saveContent: function(o) {
            if (this.config.add_widgets) {
                ...
                o.content = this.decodeDirectimagebest(o.content);
            } else if (this.config.add_directimagebest) {
                o.content = this.decodeDirectimagebest(o.content);
            }
            if(o.content!=''){
