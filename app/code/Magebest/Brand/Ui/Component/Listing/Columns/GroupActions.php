...
use Magebest\Brand\Block\Adminhtml\Group\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class GroupActions extends Column
{
	/** Url Path */
	const GROUP_URL_PATH_EDIT = 'magebestbrand/group/edit';
	const GROUP_URL_PATH_DELETE = 'magebestbrand/group/delete';
