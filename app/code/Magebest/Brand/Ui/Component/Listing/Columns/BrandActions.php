 ...
 */
namespace Magebest\Brand\Ui\Component\Listing\Columns;

use Magento\Framework\View\Element\UiComponent\ContextInterface;
use Magento\Framework\View\Element\UiComponentFactory;
use Magento\Ui\Component\Listing\Columns\Column;
use Magebest\Brand\Block\Adminhtml\Brand\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class BrandActions extends Column
{
	/** Url Path */
	const BRAND_URL_PATH_EDIT = 'magebestbrand/brand/edit';
	const BRAND_URL_PATH_DELETE = 'magebestbrand/brand/delete';
