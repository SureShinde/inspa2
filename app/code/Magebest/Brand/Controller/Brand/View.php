 ...
 */
namespace Magebest\Brand\Controller\Brand;

use Magento\Customer\Controller\AccountInterface;
use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Framework\View\Result\PageFactory;
use Magebest\Brand\Model\Layer\Resolver;
...
class View extends \Magento\Framework\App\Action\Action
{
     ...
     * @param \Magebest\Brand\Model\Brand                              $brandModel           [description]
     ...
     * @param \Magebest\Brand\Helper\Data                              $brandHelper          [description]
     */
    public function __construct(
        Context $context,
        \Magento\Store\Model\StoreManager $storeManager,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magebest\Brand\Model\Brand $brandModel,
    ...
    public function execute()
    {
        ...
        if ($brand) {
            ...
            $page->addHandle(['type' => 'MAGEBEST_BRAND_'.$brand->getId()]);
            ...
            if($collectionSize){
                $page->addHandle(['type' => 'magebestbrand_brand_layered']);
            }*/
