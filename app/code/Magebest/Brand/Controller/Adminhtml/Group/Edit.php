...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Magebest_Brand::group_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magebest_Brand::brand')
    ...
    public function execute()
    {
    	...
    	$model = $this->_objectManager->create('Magebest\Brand\Model\Group');
        ...
        $this->_coreRegistry->register('magebest_brand', $model);
