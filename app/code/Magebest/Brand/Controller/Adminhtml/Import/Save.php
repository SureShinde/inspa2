 ...
 */
namespace Magebest\Brand\Controller\Adminhtml\Import;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Magebest\Setup\Helper\Import
     */
    protected $_magebestImport;
    ...
    */
    ...
    public function execute()
    {
        ...
        try {
            ...
            if($uploader) {
                ...
                $savePath     = $tmpDirectory->getAbsolutePath('magebest/import');
                $uploader->setAllowRenameFiles(true);
                $result       = $uploader->save($savePath);
                $filePath = $tmpDirectory->getAbsolutePath('magebest/import/' . $result['file']);
                $fileContent  = file_get_contents($tmpDirectory->getAbsolutePath('magebest/import/' . $result['file']));
            }
        } catch (\Exception $e) {
                            ...
                            if($brand_values && $product_id) {
                                ...
                                foreach($brand_values as $brand_value){
                                    ...
                                    if($brand_value){
                                        ...
                                        $brand_model = $this->_objectManager->create('Magebest\Brand\Model\Brand');
    ...
    {
        return $this->_authorization->isAllowed('Magebest_Brand::import_save');
    }
}
