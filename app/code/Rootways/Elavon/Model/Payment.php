...
class Payment extends \Magento\Payment\Model\Method\Cc
{
    ...
    public function void(\Magento\Payment\Model\InfoInterface $payment)
    {
        ...
        if ($payment->getTransactionId()) {
            ...
            throw new LocalizedException(__('Error in refunding the payment.'));
        }
        return $this;
    }
    ...
    */
    private function createCharge($payment, $amount, $trn_type, $ref_id)
    {
        ...
        $ssl_transaction_currency = $order->getOrderCurrencyCode();
        ...
        if ($billingaddress->getData('region_id') != '') {
            ...
            $ssl_state = $billingaddress->getData('region');
        }
